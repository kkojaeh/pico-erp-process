...
public interface ProcessPreparationExceptions {
  ...
  @ResponseStatus(code = HttpStatus.NOT_ACCEPTABLE, reason = "process-preparation.cannot.commit.exception")
  class CannotCommitException extends RuntimeException {

    private static final long serialVersionUID = 1L;
  }

  @ResponseStatus(code = HttpStatus.NOT_ACCEPTABLE, reason = "process-preparation.cannot.complete.exception")
  class CannotCompleteException extends RuntimeException {

    private static final long serialVersionUID = 1L;
  }

  @ResponseStatus(code = HttpStatus.NOT_ACCEPTABLE, reason = "process-preparation.cannot.cancel.exception")
